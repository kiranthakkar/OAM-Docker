...
$RCU_SCRIPT -silent -dropRepository -databaseType ORACLE -connectString $DB_CONNECTION_STRING -dbUser sys -dbRole sysdba -selectDependentsForComponents true -schemaPrefix $OIM_SCHEMA_PREFIX -component OIM  -f < pwd.txt
