...
export WLDOMAIN_HOME=$MW_HOME/user_projects/domains
export OAM_DOMAIN=OAMDomain
export OIM_DOMAIN=OIMDomain
export OAM_DOMAIN_DIR=$WLDOMAIN_HOME/$OAM_DOMAIN
export OIM_DOMAIN_DIR=$WLDOMAIN_HOME/$OIM_DOMAIN
...
export OIM_ADMIN_PASSWORD=Welcome1
export OIM_PORT=14000
export OIM_FRONTEND_URL=http://`hostname`:$OIM_PORT
